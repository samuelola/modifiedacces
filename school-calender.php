  ...
  <div class="aboutus1">
    <div class="container">
      ...
      <div class="col-md-3">
          <div class="admin">
          <ul class="main">
            <li class="dashboard myactive"><a href="school-timetable-jss.php">School Calender</a></li>
      ...
      <div class="col-xs-11 col-md-8" style="margin-left: 10px;" id="make">
          ...
          <table class="table  table-responsive table-bordered">
              <thead>
                <tr>
                   <th>S/N</th>
                   <th>Programmes for third term</th>
                   <th>Date</th>
                </tr>
              </thead>
              <tbody>
                   <tr>
                     ...
                     <td>Monday 27th May 2019</td>
                   </tr>
                   <tr>
                     <td>2</td>
                     <td>Democracy day  </td>
                     <td>Wednesday 12th June, 2019</td>
                   </tr>

                   <tr>
                     <td>3</td>
                     <td>Mid – term examination  </td>
                     <td>Monday 17th June to Wednesday 19th June, 2019</td>
                   </tr>

                   <tr>
                     <td>4</td>
                     <td>Mid – term break </td>
                     <td>Thursday 20th June, to Friday 21st June, 2019</td>
                   </tr>

                   <tr>
                     <td>5</td>
                     <td>Open day  </td>
                     <td>Thursday 4th July, 2019</td>
                   </tr>

                   <tr>
                     <td>6</td>
                     <td>3rd term / promotion examination   </td>
                     <td>Thursday 11th to Friday 19th July, 2019</td>
                   </tr>

                   <tr>
                     <td>7</td>
                     <td>End of the session / graduation party   </td>
                     <td>Friday 26th July, 2019 </td>
                   </tr>

                   <tr>
                     <td>8</td>
                     <td>---   </td>
                     <td>Vacation – 2nd August, 2019. </td>
                   </tr>
