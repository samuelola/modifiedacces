...
<body>
 ...
 <header>
  ...
  <div class="aboutus1">
    <div class="container">
      <h3>School Time-table</h3>
      <hr class="mess4">
        <p><br><br></p>
      <div class="col-md-3">
          <div class="admin">
          <ul class="main">
            <li class="dashboard myactive"><a href="school-timetable-jss.php">Jss Time-table</a></li>
            <li class="edit "><a href="school-timetable-sss.php">SSS Time-table</a></li>
      ...
      <div class="col-xs-11 col-md-8" style="margin-left: 10px;" id="make">
          ...
          <img src="images/school_timetable/time_table jss.gif" class="img-responsive" alt="" />

<p><br><br></p>
          
          

             <!--<p><a class="btn btn-success" href="down.php?file=time_table jss.pdf">Download Timetable Here</a></p>-->

             <p><a class="btn btn-success" href="http://accesscollege.ng/images/school_timetable/time_table jss.pdf">Download Timetable Here</a></p>
