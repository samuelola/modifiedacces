...
<head>
  ...
  <title>Admission | Access College</title>
            ...
            <nav class="nav-section">
              <div class="container">
                ...
                <ul class="main-menu nav navbar-nav navbar-left cl-effect-15">
                  ...
                  <li class="dropdown">
                      <a href="#" class="dropdown-toggle effect-3 active" data-toggle="dropdown">Admissions
                          <b class="caret"></b>
                      </a>
                          <ul class="dropdown-menu" id="dropdown-menu">
                              <li>
  ...
  <div class="aboutus1">
    <div class="container">
      ...
      <div class="col-md-3">
          <div class="admin">
          <ul class="main">
            <li class="dashboard myactive"><a href="school-admissions.php">School Admissions</a></li>
            <li class="edit"><a href="entry-procedure.php">Entry Procedure</a></li>
            <li class="write "><a href="how-to-apply.php">How to Apply</a></li>
            <li class="comments "><a href="entrance-exam.php">Entrance Exam</a></li>
            <li class="users"><a href="tuition-fees.php">Tuition & Fees</a></li>
          </ul>
        </div>
      </div>
      
      <div class="col-xs-11 col-md-8" style="margin-left: 10px;" id="make">
            
          <p class="make1"> Admission is opened to candidates who had completed their primary education with the evidence of first school leaving certificate and testimonial.</p>

          <p class="make1">
             Admission into other classes will require placement tests or examination after we have been shown the letter of transfer; result of the previous examination written either terminal or for promotion, among others.
          </p>

          <p class="make1">
               Admission into JSS I and for 2019/2020 academic session has begun. Forms are available for sales at the following sales outlets; (i). Mulib Hospital: along Ijoko road (ii). Access Nursery and Primary school Oju ore Ota (iii). Ola – Iya Nursery and Primary school Ado – Odo and (iv) Access College Premise Joju bye-pass Ota.
          </p>

          <p class="make1">
             The first batch of the entrance examination is coming up on the 20th April, while the second batch is coming up on the 18th May, 2019.We are using this medium to appeal to our parents to please reach out to their neighbours, Friends, relatives and acquaintances for them to patronize us. 
          </p>

          <p class="make1">
             In the same vein, vacancies still exist in JSS 1 – II and SS I – II for the remaining and the last term of 2018 2019 Academic session. 
Remember! Our children school is our school, collectively we can make it great.  We appreciate some of our parents who have been very prompt in the payment of their ward(s) school fees and we appeal to other parents to please do the same. 
However, we expect all payment to have been made 2nd week of the 3rd term, while all school fees defaulters are to start turning in their tellers as soon as the school resumes on the 6th May, 2019.
