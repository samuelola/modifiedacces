...
<head>
  ...
  <title>Hods | Access College</title>
            ...
            <nav class="nav-section">
              <div class="container">
                ...
                <ul class="main-menu nav navbar-nav navbar-left cl-effect-15">
                  ...
                  <li class="dropdown">
                        <a href="#" class="dropdown-toggle effect-3 active" data-toggle="dropdown">Administration
                          <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu" id="dropdown-menu">
                           <li>
  ...
  <div class="aboutusg">
    <div class="container">
      ...
      <hr class="hori">
        ...
        <!-- Team section  -->
  <section class="team-section spad" id="spad">
    <div class="container">
      <div class="section-title text-center">
        <h3 class="hod">HOD<span >s</span> <span class="ch"><span style="text-transform: lowercase;">of</span>  Department</span></h3>
        <!--<p>The professional standards and expectations</p>-->
      </div>
      <div class="row belief">
        <div class="col-md-6 col-lg-4" id="salman">
          <div class="member">
            <div class="member-pic set-bg" data-setbg="img/member/access1010.jpg">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="member">
            <div class="member-pic set-bg" data-setbg="img/member/access21.jpg">
              <div class="member-social">
                <a href=""><i class="fa fa-facebook"></i></a>
                <a href=""><i class="fa fa-twitter"></i></a>
                <a href=""><i class="fa fa-pinterest"></i></a>
            ...
            <h5>Mrs O.G Adekunle</h5>
            <p>Arts and Humanities</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-4" id="comm">
          <div class="member">
            <div class="member-pic set-bg" data-setbg="img/member/access2222.jpg">
              <div class="member-social">
                <a href=""><i class="fa fa-facebook"></i></a>
                <a href=""><i class="fa fa-twitter"></i></a>
                <a href=""><i class="fa fa-pinterest"></i></a>
            ...
            <h5>Mr G.I Fatokun</h5>
            <p>Commerce</p>
          </div>
        </div>
        <!--<div class="col-md-6 col-lg-3">
          <div class="member">
            <div class="member-pic set-bg" data-setbg="img/member/blur-book-book-bindings-1083728.jpg">
              <div class="member-social">
                <a href=""><i class="fa fa-facebook"></i></a>
                <a href=""><i class="fa fa-twitter"></i></a>
                <a href=""><i class="fa fa-pinterest"></i></a>
      ...
      <!-- <p><br><br><br><br></p> 
      <div class="section-title text-center">
        <h3>HOD<span style="text-transform: lowercase;">s</span> Junior School</h3>
     ...
     <!-- <div class="row belief">
        <div class="col-md-6 col-lg-3">
          <div class="member">
            <div class="member-pic set-bg" data-setbg="img/member/art-arts-and-crafts-brush-159657.jpg">
              <div class="member-social">
                <a href=""><i class="fa fa-facebook"></i></a>
                <a href=""><i class="fa fa-twitter"></i></a>
                <a href=""><i class="fa fa-pinterest"></i></a>
            ...
            <h5>Biodun Philips</h5>
            <p>Mathematics Department</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="member">
            <div class="member-pic set-bg" data-setbg="img/member/batch-books-document-357514.jpg">
              <div class="member-social">
                <a href=""><i class="fa fa-facebook"></i></a>
                <a href=""><i class="fa fa-twitter"></i></a>
                <a href=""><i class="fa fa-pinterest"></i></a>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="member">
            <div class="member-pic set-bg" data-setbg="img/member/binder-blank-diary-159874.jpg">
              <div class="member-social">
                <a href=""><i class="fa fa-facebook"></i></a>
                <a href=""><i class="fa fa-twitter"></i></a>
                <a href=""><i class="fa fa-pinterest"></i></a>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="member">
            <div class="member-pic set-bg" data-setbg="img/member/black-and-white-blur-book-240163.jpg">
              <div class="member-social">
                <a href=""><i class="fa fa-facebook"></i></a>
                <a href=""><i class="fa fa-twitter"></i></a>
                <a href=""><i class="fa fa-pinterest"></i></a>
            ...
            <h5>Taylor Adegoke</h5>
          
            <p>Arts Social Science Department</p>
          </div>
        </div>
      </div>-->
