               ...
               <div class="wow bounceIn"  style="margin-top:0px;">
                    <div class="panel panel-info">
                        ...
                        <div style="padding-top:30px" class="panel-body">
                           ...
                           <div class="panel-titllle">Welcome to Student Portal Account</div>
                           <div class="panel-titlee">login to access your account</div>
                            ...
                            <form id="loginform" class="form-horizontal" action="#" method="post">
                                <div style="margin-bottom: 25px" class="input-group">
                                    ...
                                    <input id="login-username" type="text" class="form-control" name="add" value="" placeholder="Admission number" required="">
                                </div>
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                        ...
                                        <input type="submit" id="btn-twlogin" class="btn btn-info" value="Parent Sign In" name="parent">
                                    </div>
                                </div>
