  ...
  <div class="aboutus1">
    <div class="container">
      ...
      <div class="col-md-3">
          <div class="admin">
          <ul class="main">
            <li class="dashboard"><a href="school-admissions.php">School Admissions</a></li>
            <li class="edit "><a href="entry-procedure.php">Entry Procedure</a></li>
            <li class="write myactive"><a href="how-to-apply.php">How to Apply</a></li>
      ...
      <div class="col-xs-11 col-md-8" style="margin-left: 10px;" id="make">
          ...
          <p class="make1">
              ...
              Forms are available for sales at the following sales outlets; (i). Mulib Hospital: along Ijoko road (ii). Access Nursery and Primary school Oju ore Ota (iii). Ola – Iya Nursery and Primary school Ado – Odo and (iv) Access College Premise Joju bye-pass Ota.
          </p>
          <p class="make1">
          ...
          <p class="make1">
            The admission form is expected to be filled with all the require information provided and be returned to the registrar not later than a week after.
