<?php
 ...
 if(isset($_POST['forgotpass'])){
     ...
     if($count > 0){
         ...
         $str = str_shuffle($str);
         $str = substr($str,0,10);
         $url = "http://accesscollege.ng/resetpassword.php?token=$str&email=$email";
         ...
         //$mail->IsSMTP();
          ...
          $mail->SMTPSecure ='tls';
          $mail->isHTML(true);
          $mail->Username = 'sammyola122@gmail.com'; // authentication
          $mail->Password = 'sammyola12';
          $mail->setFrom('sammyola122@gmail.com'); // who is sending the mail
          $mail->addAddress($email); // where we are sending the to (recepient)
          $mail->addReplyTo($email);
          
          //$mail->addAttachment('Samuel.jpg');         
          
          $mail->Subject="reset password";
          $mail->Body="To reset your password, please visit this:".$url."";
