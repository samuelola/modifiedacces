...
<body>
    ...
    <div id="wrapper">
                       ...
                       <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                 ...
                                 <li>
                                    <a id="admin" href="notifications.html">View Exam</a>
                                </li>
                                <li>
                                    <a id="admin" href="panels-wells.html">Add Class</a>
                                </li>
                                <li>
                                    <a id="admin" href="buttons.html">Add Subject</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a id="admin" href="flot.html">View Staff</a>
                                </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <p class="create">View all Users</p>
