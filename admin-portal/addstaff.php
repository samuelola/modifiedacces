        ...
        <div id="page-wrapper" style="background-color: #f0f0f0;">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <p style="color: #555; font-size: 17px; text-align: center;padding-top:10px;padding-bottom: 15px">Add Staff Details</p>
                   <form action="" method="post" role="form" class="form-horizontal contactForm">
                       
                        <div class="form-group">
                          <label for="nameField" class="col-xs-3 meet">First Name</label> 
                           <div class="col-xs-9"> 
                        ...
                        <div class="form-group">
                          <label for="nameField" class="col-xs-3 meet">Middle Name</label> 
                           <div class="col-xs-9"> 
                              <input type="email" class="form-control" name="email" id="email"  data-rule="email" data-msg="Please enter a valid email" />
                              <div class="validation"></div>
                           </div>
                        ...
                        <div class="form-group">
                          <label for="nameField" class="col-xs-3 meet">Last Name</label> 
                          <div class="col-xs-9">
                        ...
                        <div class="form-group">
                          <label for="nameField" class="col-xs-3 meet">Email</label> 
                          <div class="col-xs-9">
                              <input type="text" class="form-control" name="email" id="email"  data-rule="email" data-msg="Please enter a valid email" />
                             <div class="validation"></div>
                          </div> 
                         ...
                         <div class="form-group">
                          <label for="nameField" class="col-xs-3 meet">Address</label> 
                          <div class="col-xs-9">
                              <input type="text" class="form-control" name="email" id="email"  data-rule="email" data-msg="Please enter a valid email" />
                             <div class="validation"></div>
                          </div> 
                        ...
                        <div class="form-group">
                           <label for="nameField" class="col-xs-3 meet">Image</label> 
                           <div class="col-xs-9">
                         ...
                         <div class="form-group">
                          <label for="nameField" class="col-xs-3 meet">Qualification</label> 
                          <div class="col-xs-9">
                              <input type="text" class="form-control" name="email" id="email"  data-rule="email" data-msg="Please enter a valid email" />
                             <div class="validation"></div>
                          </div> 
                        ...
                        <div class="form-group">
                          <label for="nameField" class="col-xs-3 meet">Country</label> 
                          <div class="col-xs-9">
                              <input type="text" class="form-control" name="email" id="email"  data-rule="email" data-msg="Please enter a valid email" />
                             <div class="validation"></div>
                          </div> 
                        ...
                        <div class="form-group">
                          <label for="nameField" class="col-xs-3 meet">State</label> 
                          <div class="col-xs-9">
                              <input type="text" class="form-control" name="email" id="email"  data-rule="email" data-msg="Please enter a valid email" />
                             <div class="validation"></div>
                          </div> 
                         ...
                         <div class="form-group">
                            <label for="nameField" class="col-xs-3 meet">Assigned Class</label> 
                            <div class="col-xs-9">
                        ...
                        <div class="form-group">
                          <label for="nameField" class="col-xs-3 meet">Telephone</label> 
                          <div class="col-xs-9">
                        ...
                        <div class="form-group">
                            <label for="nameField" class="col-xs-3 meet">Gender</label>
                            <div class="col-xs-9">
                                <select name="" id="subject" class="form-control">
                                    <option value="">--Select--</option>
                          ...
                          <input type="submit" class="text-center btn btn-primary" value="Add Staff Details" name="parent">
                      </form>
