        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <p class="create">Add Subject Details</p>
                   <form action="" method="post" role="form" class="form-horizontal contactForm">
                       
                           <div class="form-group">
                             <label for="nameField" class="col-xs-3 meet">Subject Name</label>
                             <div class="col-xs-9">
                                 <input type="text" name="name" class="form-control" id="name" placeholder="Subject Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
                              <div class="validation"></div>
                             </div>
                              
                            </div>
                        
                          <input type="submit" class="text-center btn btn-primary" value="Add Subject Details" name="parent">
                      </form>
