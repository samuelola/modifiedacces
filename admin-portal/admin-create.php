                ...
                <div class="col-md-6 col-md-offset-3">
                   ...
                   <form action="" method="post" role="form" class="form-horizontal contactForm">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-xs-9">
                              <input type="text" class="form-control" name="lastname" id="lastname" data-rule="email" data-msg="Please enter a valid email" />
                          </div> 
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                          <label for="nameField" class="col-xs-3 meet">Password</label>
                          <div class="col-xs-9">
                              <input type="password" class="form-control" name="subject" id="subject"   data-msg="Please enter at least 8 chars of subject" />
                          <div class="validation"></div>
                          </div>
                          
                        </div>
                         <div class="form-group">
                           <label for="nameField" class="col-xs-3 meet">Confirm Password</label>
                            <div class="col-xs-9">
                              <input type="password" class="form-control" name="subject" id="subject"   data-msg="Please enter at least 8 chars of subject" />
                          <div class="validation"></div>
                          </div> 
                        ...
                        <div class="form-group">
                          ...
                          <input type="submit" class="text-center btn btn-primary" value="Admin Sign In" name="parent">
                      </form>
