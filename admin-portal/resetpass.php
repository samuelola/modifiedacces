        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <p class="create">Change your Password Here</p>
                   <form action="" method="post" role="form" class="form-horizontal contactForm">
                         <div class="form-group">
                          <label for="nameField" class="col-xs-4 meet">Current Password</label>
                          <div class="col-xs-8">
                        ...
                        <div class="form-group">
                          <label for="nameField" class="col-xs-4 meet">New Password</label>
                          <div class="col-xs-8">
                              <input type="password" class="form-control" name="subject" id="subject"   data-msg="Please enter at least 8 chars of subject" />
                          <div class="validation"></div>
                          </div>
                        ...
                        <div class="form-group">
                          <label for="nameField" class="col-xs-4 meet">Confirm Password</label>
                          <div class="col-xs-8">
                              <input type="password" class="form-control" name="subject" id="subject"   data-msg="Please enter at least 8 chars of subject" />
                          <div class="validation"></div>
                          </div>
                          ...
                          <input type="submit" class="text-center btn btn-primary" value="Change Password" name="parent">
                      </form>
