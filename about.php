...
<head>
  ...
  <title>About | Access College</title>
            ...
            <nav class="nav-section">
              <div class="container">
                ...
                <ul class="main-menu nav navbar-nav navbar-left cl-effect-15">
                  ...
                  <li class="dropdown">
                     <a href="#" class="dropdown-toggle effect-3 active" data-toggle="dropdown">About Us
                          <b class="caret"></b>
                        </a>
  ...
  <div class="aboutus">
    <div class="container">
      ...
      <div class="col-md-3">
          ...
          <ul class="main">
            <li class="dashboard myactive"><a href="about.php">About Our School</a></li>
            <li class="edit"><a href="message.php">Chairman's Message</a></li>
            <li class="write "><a href="values.php">Our Values</a></li>
      ...
      <div class="col-md-8" style="margin-left: 10px;">
          ...
          <div class="row">
              <div class="col-xs-11 col-md-12" wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                
                <p class="sue">
                  <img src="images/IMG-20181128-WA0006.jpg" class="img-responsive" />
                  The journey to the realization of this vision – Access College began September, 2007 with 25 students in JSS and 10 teachers. Unlike other schools that will want to fill all the classes at once, Access College wanted to have its own groomed students from the scratch and nurture them to the apex class i.e. SS3. This is exactly what the school did till 2013 when the school produced and graduated its pioneer students.

                  <p class="make1">The success the school has achieved hitherto was a function of the passion and ingenuity of the founder and the Chief Executive Officer Dr. M.A. Ibrahim, with the active support of his wife Alhaja T.K. Ibrahim who has brought in her wealth of experience in public service especially as a teacher of long standing experience in public schools.</p>

                   <p class="make1">
                    Access College in pursuit of its academic excellence has become an household name and has been rated as one of the best schools in Ogun state. The school had won several awards in inter-schools competition, debates, spelling Bees, quiz and lots more.

                  </p>

                  <p class="make1">
                    In our quest to evolve complete and total students, it has become a tradition in Access College to expose our students to a high profile seminars, workshops, symposia and entrepreneurial skills among others. This development has made our students to stand tall among their peers wherever they find themselves.

                  </p>

                   <p class="make2">
                    Our Motto “Aiming for the best” has remained our dependable compass that direct our policies and programmes.
                     <p><br></p>
                    <p class="make3">God bless Access College.</p>
                 ...
                 <h4 id="getc" class="get" style="margin-top: -30px">Academic Staff</h4> 
                  <p class="make1" style="margin-top: -90px">
                    The school is blessed with 25 seasoned well trained teachers in diverse field of academics. Our teachers have been opportune to undergo various seminars and workshop aimed at capacity building and enhancing competencies. To this end, our teachers are equal to the task in addressing challenges in the modern day educational challenges.

                  </p> 

                  <p class="make1">
                      By same token, our non-academic staff are equal to the task in the discharge of their primary responsibilities and also share in the task of taking the school to a greater height.
                  </p>

                  
                  <h4 id="getc" class="get" style="margin-top: -30px">Facilities</h4> 
                  
                  <p class="make1" style="margin-top: -90px">
                      Our facilities are modern day compliant and they include:

                      <ul class="simply">
                         <li class="jan">Modern laboratories</li>
                         <li class="jan">State of Arts Library</li>
                         <li class="jan">Modern day ICT Laboratory</li>
                         <li class="jan">Standard Home Economics lab.</li>
                         <li class="jan">Sport ground and facilities e.g. table tennis, football match, etc.</li>
                         <li class="jan">Technical workshop </li>
                         <li class="jan">Spacious and standard classroom</li>
                         <li class="jan">School Hall, etc.</li>
                         <li class="jan">Hostel accommodation.</li>
