...
if(isset($_GET['token']) && isset($_GET['email']) && isset($_POST['reset'])){
       ...
       $sql = "SELECT * FROM parent_access WHERE admin_token = '$token' AND admin_email = '$email'";
       ...
       if($count > 0){
          ...
          if($password == $confirm){
               ...
               $parent_update = "UPDATE parent_access SET admin_password = '$pass' WHERE admin_email = '$email'";

     
           $query = mysqli_query($conn,$parent_update);  
                    ...
                    <div class="panel panel-info">
                        ...
                        <div style="padding-top:30px" class="panel-body">
                           ...
                           <a class="brandd" href="index.php"><img src="imagess/newaccess2.png" alt="image"></a>
                            ...
                            <div class="panel-titllle">Welcome to Admin Portal Account</div>
                             ...
                             <form id="loginform" class="form-horizontal" action="" method="post">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                        <input type="submit" class="btn btn-info" id="btn-login" value="Submit" name="reset">
                                        
                                        
                                    </div>

                                   <div style="margin-top:-25px;margin-bottom:50px"  id="fpassword" class="fpassword">
                                        <a class="btn btn-info" style="color: #fff!important" href="parent-login.php">Parent SignIp</a>
