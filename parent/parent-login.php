  ...
  if(isset($_POST['parent_login'])){
     ...
     $row = mysqli_fetch_assoc($result);
        ...
        if(password_verify($pass, $row['admin_password'])){
              ...
              $sql = "SELECT * FROM parent_access WHERE admin_password ='$sam'";
              $result = mysqli_query($conn,$sql);
                    ...
                    <div class="panel panel-info">
                        ...
                        <div style="padding-top:30px" class="panel-body">
                           ...
                           <a class="brandd" href="index.php"><img src="imagess/newaccess2.png" alt="image"></a>
                            ...
                            <div class="panel-info">Welcome to Admin Portal Account</div>
                            ...
                            <form id="loginform" class="form-horizontal" action="" method="post">
                                ...
                                <div class="input-group">
                                    <div class="checkbox">
                                      ...
                                      <div id="fpassword" class="fpassword">
                                          <a href="parent_fpassword.php">Forgot password?</a>
                                      </div>
                                    </div>
                                </div>
                                 <br>
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                        <input type="submit" class="btn btn-info" id="btn-login" value="Parent Sign In" name="parent_login">
                                        
                                        
                                    </div>

                                   <div style="margin-top:-25px"  id="fpassword" class="fpassword">
                                        <a class="btn btn-info" style="color: #fff!important" href="parent-register.php">Parent SignUp</a>
