...
<head>
  ...
  <title>Chairman's Message | Access College</title>
    ...
    <div class="container">
      ...
      <p><br><br></p>
       ...
       <div class="col-md-3">
          <div class="admin">
          <ul class="main">
            <li class="dashboard "><a href="about.php">About Our School</a></li>
            <li class="edit myactive"><a href="message.php">Chairman's Message</a></li>
      ...
      <div class="col-md-8" style="margin-left: 10px;">
          ...
          <div class="row">
              <div class="col-xs-11 col-md-12" wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <p class="sue1" ><img src="images/dr imbrahim.jpg"  class="img-responsive" />
                  Dr Muritala Adeleke Ibrahim - a seasoned medical doctor is the medical director Mulib Hospital, 57 ijoko road sango otta ogun state. Despite his humble beginning in life he was able to accomplish his childhood dream of becoming a medical doctor. 

                  <p class="make1">His love for schools and penchant for quality education motivated him to collaborate with his wife Mrs. Taofeekat Kofoworola Ibrahim a devoted educationist of over thirty years to establish the Access schools comprising of Nursery, Primary and Secondary.</p>
                  <p class="make1">
                    Since inception, they have never looked back in their determination to produce first class college graduates that can raise their heads anywhere they find themselves.
                  We give glory to God, Access schools has never been found wanting in all areas of human endeavors.
                  ...
                  <p class="make2">
                    This is our goal, this is our dream.
                     <p><br></p>
                    <p class="make3">Dr M.A Ibrahim</p>
                    <p class="make3">Chairman</p>
