 ...
 $message = '';
  ...
  if(isset($_POST['student'])){
      ...
      if($message == ''){
         ...
         $sql = "INSERT INTO student_access (admin_name,admin_email,admin_password,admin_token) VALUES ('$username','$email','$pass','')";
                               ...
                               <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                        <input type="submit" class="btn btn-primary" id="btn-login" value="Student Sign Up" name="student">
                                   ...
                                   <div style="margin-top:-38px"  id="fpassword" class="fpassword">
                                        <a class="btn btn-primary" style="color: #fff!important" href="student-login.php">Student SignIn</a>
