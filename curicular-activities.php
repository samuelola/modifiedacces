...
<body>
 ...
 <header>
  ...
  <div class="aboutus1">
    <div class="container">
      <h3>Extra / Co-curicular Activities</h3>
      <hr class="mess4">
        <p><br><br></p>
      <div class="col-md-3">
          <div class="admin">
          <ul class="main">
            ...
            <li class="edit "><a href="teachers-duty.php">Teachers Duty Roaster</a></li>
            <li class="edit "><a href="class-managers.php">Committee / Class Managers</a></li>
            <li class="edit "><a href="clubs-societies.php">Club & Societies</a></li>
            <li class="edit myactive"><a href="curicular-activities.php">Extra / Co-curicular Activities</a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="col-xs-11 col-md-8" style="margin-left: 10px;" id="make">
         ...
         <h5 class="text-center" style="margin-left: 7px !important">2018/2019 ACADEMIC SESSION
COMMITTEE / CLASS MANAGERS
 </h5>
           <table class="table table-bordered table-responsive" >
                ...
                <tbody>
                   <tr>
                    ...
                    <tr>
                     <td>3</td>
                     <td>NEWSPAPER REVIEW</td>
                     
                   </tr>
                   <tr>
                     <td>4</td>
                     <td>INTER CLASS SPELLING BEE COMPETITION</td>
                    
                   </tr>
                   <tr>
                     <td>5</td>
                     <td>INTER CLASS DEBATE   </td>
                   ...
                   <tr>
                     <td>8</td>
                     <td>INTER CLASS QUIZ COMPETITION</td>
                     
                   </tr>
                   <tr>
                     <td>9</td>
                     <td>QUIZ COMPETITION (CURRENT AFFAIRS)</td>
                     
                   </tr>
                   <tr>
                     <td>10</td>
                     <td>LION QUEST PROGRAM </td>
                ...
                <div class="col-md-6">
                    <p><br></p>
                        ...
                        <p>1. MRS O.G. ADEKUNLE (CHAIRPERSON)</p>
                        <p>2. MISS O.O. AKINDURO (DEPUTY)</p>
                        <p>3. MR G.I. FATOKUN (MEMBER)</p>
                        <p>4. MR A.O. AJIMOTOKAN (MEMBER)</p>
                        <p>5. MR O.M. SALMAN (MEMBER)</p>
...
<p><br><br></p>
          <p class="it"><a class="btn btn-success" href="#">Download  Here</a></p>
