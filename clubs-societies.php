              ...
              <div class="container">
                ...
                <ul class="main-menu nav navbar-nav navbar-left cl-effect-15">
                  ...
                  <li class="dropdown">
                    ...
                    <li class="dropdown">
                                <a href="#" class="dropdown-toggle  " data-toggle="dropdown">Portal
                                    <b class="caret"></b>
                                </a>
                        <ul class="dropdown-menu" id="dropdown-menu">
                            <li>
    ...
    <div class="container">
      ...
      <div class="col-md-3">
          ...
          <ul class="main">
            ...
            <li class="edit myactive"><a href="clubs-societies.php.php">Club & Societies</a></li>
      ...
      <div class="col-xs-11 col-md-8" style="margin-left: 10px;" id="make">
         ...
         <h5 class="text-center" style="margin-left: 7px !important">CLUBS & SOCIETIES
            ...
            <div class="row">
                <div class="col-md-6">
                    <p><br></p>
                        ...
                        <p>1. MR. O. ADEJUBE (CO-ORDINATOR)</p>
                        <p>2. MR O.M. SALMAN</p>
                        <p>3. MR E.T. DAGUNDURO</p>
                        <p>4. MISS. A.A. AMEYE</p>
                        
                        <p><br></p>

                        <h6>PRESS CLUB</h6>
                        
                        <p>1. MRS O.G. ADEKUNLE (CO-ORDINATOR)</p>
                        <p>2. MISS O.O. AKINDURO</p>
                        <p>3. MR G.I. FATOKUN</p>
                        

                        <p><br></p>
                        
                        <h6>DRAMA/CULTURAL</h6>
                        
                        <p>1. MRS. N.F. AZEEZ</p>
                        <p>2. MRS. O. OYEGUNLE</p>
                        <p>3. MRS O. BAMIDURO</p>
                ...
                <div class="col-md-6">
                  <p><br></p>
                    ...
                    <p>1. MRS. O.B. ANYANWU</p>
                    <p>2. MR. A.O. AJIMOTOKAN</p>
                    <p>3. MR. S.A. OKUSANYA</p>
                    
                    
                   

                    <p><br></p>
                    <h6>YOUNG FARMERS CLUB</h6>
...
<p><br><br></p>
          <p><a class="btn btn-success" href="#">Download  Here</a></p>
