<?php
 ...
 $message = '';
  ...
  if(isset($_POST['teacher_login'])){
     ...
     $sql = " SELECT * FROM teacher_access WHERE admin_email = '$email'";
     ...
     $row = mysqli_fetch_assoc($result);
        ...
        if(password_verify($pass, $row['admin_password'])){
              ...
              $sql = "SELECT * FROM teacher_access WHERE admin_password ='$sam'";
              $result = mysqli_query($conn,$sql);
                            ...
                            <form id="loginform" class="form-horizontal" action="" method="post">
                                ...
                                <div class="input-group">
                                    <div class="checkbox">
                                      ...
                                      <div id="fpassword" class="fpassword">
                                          <a href="teacher_fpassword.php">Forgot password?</a>
                                      </div>
                                    </div>
                                </div>
                                 <br>
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                        <input type="submit" class="btn btn-primary" id="btn-login" value="Teacher Sign In" name="teacher_login">
                                        
                                        
                                    </div>

                                   <div style="margin-top:-25px"  id="fpassword" class="fpassword">
                                        <a class="btn btn-primary" style="color: #fff!important" href="teacher-register.php">Teacher SignUp</a>
