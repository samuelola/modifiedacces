<?php
 ...
 if(isset($_POST['forgotpass'])){
     ...
     if($count > 0){
         ...
         $update_token = "UPDATE teacher_access SET admin_token = '$str' WHERE admin_email = '$email'";
                             ...
                             <form id="loginform" class="form-horizontal" action="" method="post">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                        <input type="submit" class="btn btn-primary" id="btn-login" value="Request Password" name="forgotpass">
