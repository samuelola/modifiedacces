...
if(isset($_GET['token']) && isset($_GET['email']) && isset($_POST['reset'])){
       ...
       $sql = "SELECT * FROM teacher_access WHERE admin_token = '$token' AND admin_email = '$email'";
       ...
       if($count > 0){
          ...
          if($password == $confirm){
              ...
              $teacher_update = "UPDATE teacher_access SET admin_password = '$pass' WHERE admin_email = '$email'";
     
           $query = mysqli_query($conn,$teacher_update);
...
<head>
  ...
  <title>Teacher's Portal | Access College</title>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div style="padding-top:30px" class="panel-body">
                           ...
                           <a class="brandd" href="index.php"><img src="imagess/newaccess2.png" alt="image"></a>
                            ...
                            <div class="panel-titl">Welcome to Teacher Portal Account</div>
                           <div class="panel-titlee">Enter your new password </div>
                             ...
                             <form id="loginform" class="form-horizontal" action="" method="post">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                        <input type="submit" class="btn btn-primary" id="btn-login" value="Submit" name="reset">
                                        
                                        
                                    </div>

                                   <div style="margin-top:-25px;margin-bottom:50px"  id="fpassword" class="fpassword">
                                        <a class="btn btn-primary" style="color: #fff!important" href="teacher-login.php">Teacher SignIn</a>
