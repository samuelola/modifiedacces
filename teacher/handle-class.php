            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a id="admin" href="#"><i class="fa fa-graduation-cap"></i> Profile</a>
                        </li>
                        <li>
                            <a id="admin" href="handle-class.php"><i class="fa fa-book fa-fw"></i>Handle Class</a>
                        </li>
                        ...
                        <li>
                            <a id="admin" href="view-stud.php"><i class="fa fa-eye fa-fw"></i>View Students</a>
                        </li>
