 ...
 $message = '';
  ...
  if(isset($_POST['teacher'])){
      ...
      if($message == ''){
         ...
         $sql = "INSERT INTO teacher_access (admin_name,admin_email,admin_password,admin_token) VALUES ('$username','$email','$pass','')";
                               ...
                               <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                        <input type="submit" class="btn btn-primary" id="btn-login" value="Teacher Sign Up" name="teacher">
