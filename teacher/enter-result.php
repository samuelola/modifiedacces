<?php
 if(isset($_GET['result'])){
     ...
     //header("Location:view-generated-results.php"); 
      echo"<script>alert('The Result has been entered succesfully!')</script>";
      echo "<script>window.open('generate-result.php','_self')</script>";
  }
?>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="background-color: #f0f0f0;">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                 ...
                 <form action="" method="get">
                             ...
                             <p>Enter Donald result &nbsp;[ABC12020] </p>
                            ...
                            <table class="table  timetable_sub table-responsive ">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Subjects</th>
                                        <th>1st term CA Score</th>
                                        <th>2nd term CA Score</th>
                                        <th>Exam Score</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>Mathematics</td>
                                        <td><input type="text" name="mat1" class="wts1"></td>
                                        <td><input type="text" name="" class="wts1"></td>
                                        <td><input type="text" name="" class="wts1"></td>
                                    ...
                                    <tr>
                                        <td>Physics</td>
                                        <td><input type="text" name="phy1" class="wts1"></td>
                                        <td><input type="text" name="" class="wts1"></td>
                                        <td><input type="text" name="" class="wts1"></td>
                                    ...
                                    <tr>
                                        <td>Biology</td>
                                        <td><input type="text" name="bio1" class="wts1"></td>
                                        <td><input type="text" name="" class="wts1"></td>
                                        <td><input type="text" name="" class="wts1"></td>
                                    ...
                                    <tr>
                                        <td>English</td>
                                        <td><input type="text" name="eng1" class="wts1"></td>
                                        <td><input type="text" name="" class="wts1"></td>
                                        <td><input type="text" name="" class="wts1"></td>
                                    ...
                                    <tr>
                                        <td>Geography</td>
                                        <td><input type="text" name="geo1" class="wts1"></td>
                                        <td><input type="text" name="" class="wts1"></td>
                                        <td><input type="text" name="" class="wts1"></td>
            ...
            <div class="row">
                    ...
                    <div class="box3">
                            ...
                            <table class="table  table-responsive ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Teacher</td>
                                        <td><input type="text" name="remark" class="wts2"></td>
                  ...
                  <input type="submit" class="btn btn-primary tric" id="btn-fblogin" value="Submit Result" name="result">
