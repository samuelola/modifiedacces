...
<head>
  ...
  <title>Management-staff | Access College</title>
    ...
    <div class="container">
      ...
      <div class="team">
        ...
        <div class="row clearfix">
          <div class="col-xs-6 col-sm-6 col-md-4 " id="expand"> 
            <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="media" id="media">
                <div class="pull-left">
                  <a href="#"><img class="media-object" src="images/dr imbrahim.jpg" alt=""></a>
                </div>
                <div class="media-body">
                  <h4 class="doe">Dr. M.A Ibrahim</h4>
                  <h5>Chairman</h5>
          ...
          <div class="col-xs-6 col-sm-6 col-md-4 col-md-offset-2" id="expand1"> 
            <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="media">
                <div class="pull-left">
                  <a href="#"><img class="media-object" src="images/access2020.jpg" alt=""></a>
                </div>
                <div class="media-body">
                  <h4 class="doe">Lady T.K Ibrahim</h4>
                  <h5>Proprietress</h5>
        ...
        <div class="row clearfix">   
          ...
          <div class="col-xs-6 col-sm-6 col-md-4 col-md-offset-2" id="expand"> 
            <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="media">
                <div class="pull-left">
                  <a href="#"><img class="media-object" src="images/access1111.jpg" alt=""></a>
                </div>
                <div class="media-body">
                  <h4 class="doe">Mr M.O Adesoye</h4>
                  <h5>Principal</h5>
          ...
          <div class="col-xs-6 col-sm-6 col-md-4 col-md-offset-2" id="expand1"> 
            <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="media">
                <div class="pull-left">
                  <a href="#"><img class="media-object" src="images/access1010.jpg" alt=""></a>
                </div>
                <div class="media-body">
                  <h4 class="doe">Mr O.M Salman</h4>
        ...
        <div class="row clearfix">
          <div class="col-xs-6 col-sm-6 col-md-4" id="expand"> 
            <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="media">
                <div class="pull-left">
                  <a href="#"><img class="media-object" src="images/access99.jpg" alt=""></a>
                </div>
                <div class="media-body">
                  <h4 class="doe">Mr A.O Ajimotokan</h4>
                  <h5>Registrar</h5>
          ...
          <div class="col-xs-6  col-sm-6 col-md-4 col-md-offset-2" id="expand"> 
            <div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="media">
                <div class="pull-left">
                  <a href="#"><img class="media-object" src="images/access1212.jpg" alt=""></a>
                </div>
                <div class="media-body">
                  <h4 class="doe">Mr M.O Olawole</h4>
                  <h5>Coordinator</h5>
