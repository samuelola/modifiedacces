  ...
  <div class="aboutus1">
    <div class="container">
      ...
      <div class="col-md-3">
          <div class="admin">
          <ul class="main">
            <li class="dashboard "><a href="school-timetable-jss.php">Jss Time-table</a></li>
            <li class="edit myactive"><a href="school-timetable-sss.php">SSS Time-table</a></li>
      ...
      <div class="col-xs-11 col-md-8" style="margin-left: 10px;" id="make">
          ...
          <img src="images/school_timetable/time_table sss.gif" class="img-responsive" alt="" />
          
         <p><br><br></p>
           <p><a class="btn btn-success" href="http://accesscollege.ng/images/school_timetable/time_table sss.pdf">Download Timetable Here</a></p>    
      </div>
